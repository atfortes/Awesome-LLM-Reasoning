...
- **[EasyInstruct](https://github.com/zjunlp/EasyInstruct)**  Package for instructing Large Language Models (LLMs) like GPT-3 in your research experiments. It is designed to be easy to use and easy to extend.
