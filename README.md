...
1. **REFINER: Reasoning Feedback on Intermediate Representations.** `Preprint`
    ...
    *Debjit Paul, Mete Ismayilzada, Maxime Peyrard, Beatriz Borges, Antoine Bosselut, Robert West, Boi Faltings.* [[Paper](https://arxiv.org/abs/2304.01904)], [Code](https://github.com/debjitpaul/refiner), [Blog Post](https://debjitpaul.github.io/refiner/) 2023.4
