...
<p align="center">
    Large Language models have revolutionized the landscape of Natural Language Processing, showing improved performance and sample efficiency over smaller models. However, increasing model size alone has not proved sufficient for achieving high performance on challenging reasoning tasks, such as solving arithmetic problems or answering commonsense questions. <b> This repository contains a collection of papers and resources which explore how the reasoning ability of language models can be unlocked.</b>
</p>
...
1. **Towards Understanding Chain-of-Thought Prompting: An Empirical Study of What Matters.** `Preprint`
...
1. **On Second Thought, Let's Not Think Step by Step! Bias and Toxicity in Zero-Shot Reasoning.** `Preprint`
...
1. **Large Language Models Can Be Easily Distracted by Irrelevant Context.** `Preprint`
...
1. **Self-consistency improves chain of thought reasoning in language models.** `Preprint`
...
1. **Least-to-most prompting enables complex reasoning in large language models.** `Preprint`
...
1. **On the Advance of Making Language Models Better Reasoners.** `Preprint`
...
1. **Ask Me Anything: A simple strategy for prompting language models.** `Preprint`
...
1. **PAL: Program-aided Language Models.** `Preprint`
...
1. **Complementary Explanations for Effective In-Context Learning.** `Preprint`
...
1. **Distilling Multi-Step Reasoning Capabilities of Large Language Models into Smaller Models via Semantic Decompositions.** `Preprint`
